 ...
 *
 * @author Dayat-Madani <rahmandayat123@gmail.com>
 * @since  1.8
 */
class Menu
{
    ...
    private function default_menu()
    {
        $this->menus['admin'] = array(
            ...
            3 => array(
                '<a href="' . site_url('kelas/mapel_kelas') . '"><i class="menu-icon icon-paste"></i>Matakuliah Kelas </a>',
                '<a href="' . site_url('kelas') . '"><i class="menu-icon icon-tasks"></i>Manajemen Kelas </a>',
                '<a href="' . site_url('mapel') . '"><i class="menu-icon icon-book"></i>Manajemen Matakuliah </a>'
            ),

            4 => array(
                '<a href="' . site_url('feedback/add') . '"><i class="menu-icon icon-tasks"></i>Feedback</a>'
            ),
            5 => array(
                ...
                #'<a href="' . site_url('welcome/update_info') . '"><i class="menu-icon icon-info-sign"></i>Update Aplikasi aa<span class="menu-count-new-update"></span></a>'
            ),
            6 => array(
        ...
        $this->menus['siswa'] = array(
            0 => array(
                '<a href="' . site_url() . '"><i class="menu-icon icon-home"></i>Beranda</a>',
                #'<a href="' . site_url('message') . '"><i class="menu-icon icon-comments"></i>Pesan <span class="menu-count-new-msg"></span></a>',
                '<a href="' . site_url('siswa/jadwal_mapel') . '"><i class="menu-icon icon-tasks"></i>Jadwal Matakuliah</a>'
            ),
            1 => array(
                '<a href="' . site_url('tugas?clear_filter=true') . '"><i class="menu-icon icon-tasks"></i>Tugas </a>',
                '<a href="' . site_url('materi?clear_filter=true') . '"><i class="menu-icon icon-book"></i>Materi </a>',
