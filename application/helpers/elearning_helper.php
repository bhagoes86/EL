...
function default_parser_item($add_item = array())
{
    ...
    $return = array(
        ...
        'copyright_setup'   => 'Copyright &copy; 2017 - ' . date('Y') . ' Dayat-Madani - <a href="https://www.instagram.com/hidayaturrahmann/?hl=en">instagram</a>',
    ...
    if ($CI->uri->segment(1) != 'setup') {
        $return['copyright'] = 'Copyright &copy;  - ' . date('Y') . ' ' . get_pengaturan('nama-sekolah', 'value').' by <a href="https://www.instagram.com/hidayaturrahmann/?hl=en">Dayat</a> - <a href="https://www.instagram.com/madani.mf/?hl=en">Madani</a>';
        $return['site_name'] = 'E-Learning '.get_pengaturan('nama-sekolah', 'value');
        
        #update souce code
       #$return['version']   = '<a href="https://www.instagram.com/hidayaturrahmann/?hl=en">versi ' . get_pengaturan('versi', 'value') . '</a>';
...
{
    return "Maaf, halaman ini tidak dapat diperbaharui.";
}
