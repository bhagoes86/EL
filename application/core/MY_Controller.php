...
class MY_Controller extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model(array('config_model', 'kelas_model', 'login_model', 'mapel_model', 'materi_model', 'pengajar_model', 'siswa_model', 'tugas_model', 'msg_model', 'pengumuman_model', 'komentar_model','feedback_model'));
    ...
    function check_new_version($skip_check_time = false)
    {
        ...
        if ($ok_check) {
            ...
            $url_new_version = 'https://www.instagram.com/hidayaturrahmann/?hl=en' . http_build_query($http_query);
