        ...
        if ($sebagai == 'siswa') {
            if ($this->form_validation->run('register/siswa') == true) {
                ...
                if ($status_id == 1) {
                    ...
                    $pesan = "Registrasi sebagai mahasiswa berhasil, silakan " . anchor('login/index', 'LOG IN') . " ke sistem.";
                } else {
                    ...
                    $pesan = "Registrasi sebagai mahasiswa berhasil, tunggu pengaktifan akun oleh admin.";
                }
