 ...
 * @since     1.0
 * @link      https://www.instagram.com/hidayaturrahmann/?hl=en
 *
 * INDEMNITY
                ...
                if (empty($this->db_error)) {
                    ...
                    $data_pengaturan = array(
                        ...
                        array(
                            ...
                            'value' => '{"subject":"Pengaktifan Akun","body":"<p>Hai {$nama},<\\/p>\\n<p>Anda telah diterima sebagai mahasiswa pada {$nama_sekolah}, berikut informasi data diri anda:<\\/p>\\n<p>{$tabel_profil}<\\/p>\\n<p>Anda dapat login ke sistem E-Learning menggunakan username dan password yang telah anda buat saat pendaftaran, login pada url berikut : {$url_login}<\\/p>"}'
                        ),
                        array(
                        ...
                        array(
                            ...
                            'value' => '{"subject":"Registrasi Berhasil","body":"<p>Hai {$nama},<\\/p>\\n<p>Terimakasih telah melakukan pendaftaran sebagai mahasiswa di E-Learning {$nama_sekolah}. Akun anda akan segera diaktifkan oleh admin.<\\/p>"}'
                        ),
                        array(
                            'id'    => 'info-registrasi',
                            'nama'  => 'Info Registrasi',
                            'value' => '<p>Silakan mendaftar sebagai mahasiswa atau pengajar (jika anda sebagai pengajar) dengan memilih sesuai tab berikut :</p>'
                        ),
                        array(
